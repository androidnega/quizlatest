<div class="grid gap-5">
    <div>
        ...
        <input id="name" name="name" type="text" required value="{{ old('name', $coordinator->name ?? '') }}" class="mt-1 block w-full rounded-md border-qs-soft focus:border-qs-soft focus:ring-qs-accent/40 bg-white" />
        @error('name')
    ...
    <div>
        ...
        <input id="email" name="email" type="text" required value="{{ old('email', $coordinator->email ?? '') }}" class="mt-1 block w-full rounded-md border-qs-soft focus:border-qs-soft focus:ring-qs-accent/40 bg-white" />
        @error('email')
            <p class="mt-1 text-sm text-qs-danger">{{ $message }}</p>
        @enderror
    </div>
    ...
    <div>
        ...
        <input id="index_number" name="index_number" type="text" value="{{ old('index_number', $coordinator->index_number ?? '') }}" class="mt-1 block w-full rounded-md border-qs-soft focus:border-qs-soft focus:ring-qs-accent/40 bg-white" />
        @error('index_number')
            <p class="mt-1 text-sm text-qs-danger">{{ $message }}</p>
        @enderror
    </div>
    ...
    <div>
        ...
        <input id="password" name="password" type="password" {{ isset($coordinator) ? '' : 'required' }} class="mt-1 block w-full rounded-md border-qs-soft focus:border-qs-soft focus:ring-qs-accent/40 bg-white" />
        @error('password')
            <p class="mt-1 text-sm text-qs-danger">{{ $message }}</p>
        @enderror
    </div>
    ...
    <div>
        ...
        <select id="department_ids" name="department_ids[]" multiple required class="mt-1 block w-full rounded-md border-qs-soft focus:border-qs-soft focus:ring-qs-accent/40 bg-white min-h-52">
...
<div class="mt-6 flex items-center justify-end gap-3">
    <a href="{{ route('admin.coordinators.index') }}" class="px-4 py-2 rounded-md text-sm border border-qs-soft text-qs-muted bg-white hover:bg-qs-card">
        Cancel
    </a>
