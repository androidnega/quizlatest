                ...
                <tbody>
                    @forelse ($answers as $answer)
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{ route('coordinator.grading.show', $answer) }}" class="qs-btn-primary inline-flex min-h-[44px] items-center justify-center px-4 py-2 text-xs font-semibold">{{ __('Grade') }}</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
