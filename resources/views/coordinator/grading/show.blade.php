<x-layouts.coordinator>
    ...
    <div class="max-w-3xl space-y-6">
        <div class="bg-white rounded-xl border border-beige p-5 text-sm">
        ...
        <form method="post" action="{{ route('coordinator.grading.grade', $answer) }}" class="bg-white rounded-xl border border-beige p-5 space-y-4">
            @csrf
            <div>
            ...
            <div class="flex gap-3">
                <button type="submit" class="rounded-lg bg-camel px-4 py-2 text-sm font-semibold text-white hover:bg-camel/90">Save grade</button>
