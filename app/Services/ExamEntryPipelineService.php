...
class ExamEntryPipelineService
{
    ...
    {
        // 1. Validate student session access
        ...
        // 3. Apply global orchestrator-facing overrides for visibility (merged copy)
        ...
        // 4. Face verification (threshold only adjusted by governance relax flag — same comparator)
        ...
        // 5. Device capability (heuristic; no AI)
        $capabilityHints = [
